...
Each screen has its own `scale` property. Under the hood, `screen.scale` delegates to `output.scale` on the backing [output](/docs/reference/output) object, keeping a single source of truth:
...
- [Fractional Scaling Guide](/docs/guides/fractional-scaling) - Practical configuration
- [output Reference](/docs/reference/output) - Output object API (hardware identification, display configuration)
- [screen Reference](/docs/reference/screen) - API documentation
