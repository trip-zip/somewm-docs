...
Complete enumeration of every keysym name SomeWM accepts in `awful.key` bindings. **2629 keysyms** in 37 categories.
...
This page is generated from `/usr/include/xkbcommon/xkbcommon-keysyms.h` on the build host. SomeWM links against the same libxkbcommon at runtime, so the lists are identical.
:::

<details>
<summary>Special keysyms (2 keys)</summary>
...
<details>
<summary>TTY function keys (97 keys)</summary>
...
| `script_switch` | `0xff7e` | non-deprecated alias for Mode_switch |
| `Num_Lock` | `0xff7f` |  |
...
<details>
<summary>Auxiliary functions (74 keys)</summary>
...
<details>
<summary>Keyboard (XKB) Extension function and modifier keys (147 keys)</summary>
...
| `ISO_Group_Shift` | `0xff7e` | non-deprecated alias for Mode_switch |
...
| `dead_tilde` | `0xfe53` |  |
| `dead_perispomeni` | `0xfe53` | non-deprecated alias for dead_tilde |
| `dead_macron` | `0xfe54` |  |
| `dead_breve` | `0xfe55` |  |
...
| `dead_psili` | `0xfe64` | non-deprecated alias for dead_abovecomma |
| `dead_abovereversedcomma` | `0xfe65` |  |
| `dead_dasia` | `0xfe65` | non-deprecated alias for dead_abovereversedcomma |
...
| `dead_u` | `0xfe88` |  |
| `dead_U` | `0xfe89` |  |
| ~~`dead_small_schwa`~~ | `0xfe8a` | deprecated alias for dead_schwa |
| `dead_schwa` | `0xfe8a` |  |
| ~~`dead_capital_schwa`~~ | `0xfe8b` | deprecated alias for dead_SCHWA |
| `dead_SCHWA` | `0xfe8b` |  |
| `dead_greek` | `0xfe8c` |  |
| `dead_hamza` | `0xfe8d` |  |
...
<details>
<summary>3270 Terminal Keys (30 keys)</summary>
...
<details>
<summary>Latin 1 (200 keys)</summary>
...
| ~~`guillemotleft`~~ | `0x00ab` | deprecated alias for guillemetleft (misspelling) |
...
| ~~`masculine`~~ | `0x00ba` | deprecated alias for ordmasculine (inconsistent name) |
| `ordmasculine` | `0x00ba` | U+00BA MASCULINE ORDINAL INDICATOR |
| ~~`guillemotright`~~ | `0x00bb` | deprecated alias for guillemetright (misspelling) |
...
<details>
<summary>Latin 2 (57 keys)</summary>
...
<details>
<summary>Latin 3 (22 keys)</summary>
...
<details>
<summary>Latin 4 (36 keys)</summary>
...
<details>
<summary>Latin 8 (26 keys)</summary>
...
<details>
<summary>Latin 9 (3 keys)</summary>
...
<details>
<summary>Katakana (70 keys)</summary>
...
| `kana_switch` | `0xff7e` | non-deprecated alias for Mode_switch |

</details>
<details>
<summary>Arabic (91 keys)</summary>
...
| ~~`Arabic_farsi_yeh`~~ | `0x10006cc` | deprecated alias for Farsi_yeh |
| `Arabic_yeh_baree` | `0x10006d2` | U+06D2 ARABIC LETTER YEH BARREE |
| `Arabic_heh_goal` | `0x10006c1` | U+06C1 ARABIC LETTER HEH GOAL |
| `Arabic_switch` | `0xff7e` | non-deprecated alias for Mode_switch |

</details>
<details>
<summary>Cyrillic (139 keys)</summary>
...
| ~~`Greek_IOTAdiaeresis`~~ | `0x07a5` | deprecated (old typo) |
...
| `Greek_LAMBDA` | `0x07cb` | non-deprecated alias for Greek_LAMDA |
...
| `Greek_lambda` | `0x07eb` | non-deprecated alias for Greek_lamda |
...
| `Greek_switch` | `0xff7e` | non-deprecated alias for Mode_switch |

</details>
<details>
<summary>Technical (49 keys)</summary>
...
<details>
<summary>Special (24 keys)</summary>
...
<details>
<summary>Publishing (84 keys)</summary>
...
<details>
<summary>Hebrew (40 keys)</summary>
...
| `Hebrew_switch` | `0xff7e` | non-deprecated alias for Mode_switch |

</details>
<details>
<summary>Thai (84 keys)</summary>
...
<details>
<summary>Korean (107 keys)</summary>
...
| `Hangul_switch` | `0xff7e` | non-deprecated alias for Mode_switch |
...
<details>
<summary>Armenian (90 keys)</summary>
...
| ~~`Armenian_verjaket`~~ | `0x1000589` | deprecated alias for Armenian_full_stop |
| `Armenian_separation_mark` | `0x100055d` | U+055D ARMENIAN COMMA |
| ~~`Armenian_but`~~ | `0x100055d` | deprecated alias for Armenian_separation_mark |
| `Armenian_hyphen` | `0x100058a` | U+058A ARMENIAN HYPHEN |
| ~~`Armenian_yentamna`~~ | `0x100058a` | deprecated alias for Armenian_hyphen |
| `Armenian_exclam` | `0x100055c` | U+055C ARMENIAN EXCLAMATION MARK |
| ~~`Armenian_amanak`~~ | `0x100055c` | deprecated alias for Armenian_exclam |
| `Armenian_accent` | `0x100055b` | U+055B ARMENIAN EMPHASIS MARK |
| ~~`Armenian_shesht`~~ | `0x100055b` | deprecated alias for Armenian_accent |
| `Armenian_question` | `0x100055e` | U+055E ARMENIAN QUESTION MARK |
| ~~`Armenian_paruyk`~~ | `0x100055e` | deprecated alias for Armenian_question |
...
<details>
<summary>Georgian (39 keys)</summary>
...
<details>
<summary>Azeri (and other Turkic or Caucasian languages) (18 keys)</summary>
...
<details>
<summary>Vietnamese (408 keys)</summary>
...
<details>
<summary>Sinhala (80 keys)</summary>
...
<details>
<summary>XFree86 vendor specific keysyms (7 keys)</summary>
...
<details>
<summary>Keys found on some "Internet" keyboards (178 keys)</summary>
...
| `XF86MediaSelectCD` | `0x1008ff53` | Alias for XF86CD |
...
<details>
<summary>Reserved range for evdev symbols (208 keys)</summary>

| Name | Hex | Notes |
| --- | --- | --- |
| `XF86MediaPlayPause` | `0x100810a4` | KEY_PLAYPAUSE |
| `XF86Exit` | `0x100810ae` | KEY_EXIT |
| `XF86AudioBassBoost` | `0x100810d1` | KEY_BASSBOOST |
| `XF86Sport` | `0x100810dc` | KEY_SPORT |
| ~~`XF86BrightnessAuto`~~ | `0x100810f4` | Deprecated alias for XF86MonBrightnessAuto |
...
| `XF86MediaSelectDVD` | `0x10081185` | Alias for XF86DVD |
...
<details>
<summary>Floating Accent (6 keys)</summary>
...
<details>
<summary>Miscellaneous Functions (4 keys)</summary>
...
| `SunPrint_Screen` | `0x0000ff61` | Same as XKB_KEY_Print |

</details>
<details>
<summary>International & Multi-Key Character Composition (2 keys)</summary>

| Name | Hex | Notes |
| --- | --- | --- |
| `SunCompose` | `0x0000ff20` | Same as XKB_KEY_Multi_key |
| `SunAltGraph` | `0x0000ff7e` | Same as XKB_KEY_Mode_switch |

</details>
<details>
<summary>Cursor Control (2 keys)</summary>

| Name | Hex | Notes |
| --- | --- | --- |
| `SunPageUp` | `0x0000ff55` | Same as XKB_KEY_Prior |
| `SunPageDown` | `0x0000ff56` | Same as XKB_KEY_Next |

</details>
<details>
<summary>Open Look Functions (18 keys)</summary>

| Name | Hex | Notes |
| --- | --- | --- |
| `SunUndo` | `0x0000ff65` | Same as XKB_KEY_Undo |
| `SunAgain` | `0x0000ff66` | Same as XKB_KEY_Redo |
| `SunFind` | `0x0000ff68` | Same as XKB_KEY_Find |
| `SunStop` | `0x0000ff69` | Same as XKB_KEY_Cancel |
| `SunProps` | `0x1005ff70` |  |
| `SunFront` | `0x1005ff71` |  |
| `SunCopy` | `0x1005ff72` |  |
| `SunOpen` | `0x1005ff73` |  |
...
<details>
<summary>DEC private keysyms (71 keys)</summary>
...
| ~~`hpIO`~~ | `0x100000ee` | deprecated alias for hpYdiaeresis |
...
<details>
<summary>The use of the following macros is deprecated (22 keys)</summary>

| Name | Hex | Notes |
| --- | --- | --- |
| ~~`Reset`~~ | `0x1000ff6c` | deprecated alias for hpReset |
| ~~`System`~~ | `0x1000ff6d` | deprecated alias for hpSystem |
| ~~`User`~~ | `0x1000ff6e` | deprecated alias for hpUser |
| ~~`ClearLine`~~ | `0x1000ff6f` | deprecated alias for hpClearLine |
| ~~`InsertLine`~~ | `0x1000ff70` | deprecated alias for hpInsertLine |
| ~~`DeleteLine`~~ | `0x1000ff71` | deprecated alias for hpDeleteLine |
| ~~`InsertChar`~~ | `0x1000ff72` | deprecated alias for hpInsertChar |
| ~~`DeleteChar`~~ | `0x1000ff73` | deprecated alias for hpDeleteChar |
| ~~`BackTab`~~ | `0x1000ff74` | deprecated alias for hpBackTab |
| ~~`KP_BackTab`~~ | `0x1000ff75` | deprecated alias for hpKP_BackTab |
| ~~`Ext16bit_L`~~ | `0x1000ff76` | deprecated |
| ~~`Ext16bit_R`~~ | `0x1000ff77` | deprecated |
| ~~`mute_acute`~~ | `0x100000a8` | deprecated alias for hpmute_acute |
| ~~`mute_grave`~~ | `0x100000a9` | deprecated alias for hpmute_grave |
| ~~`mute_asciicircum`~~ | `0x100000aa` | deprecated alias for hpmute_asciicircum |
| ~~`mute_diaeresis`~~ | `0x100000ab` | deprecated alias for hpmute_diaeresis |
| ~~`mute_asciitilde`~~ | `0x100000ac` | deprecated alias for hpmute_asciitilde |
| ~~`lira`~~ | `0x100000af` | deprecated alias for hplira |
| ~~`guilder`~~ | `0x100000be` | deprecated alias for hpguilder |
| ~~`IO`~~ | `0x100000ee` | deprecated alias for hpYdiaeresis |
| ~~`longminus`~~ | `0x100000f6` | deprecated alias for hplongminus |
| ~~`block`~~ | `0x100000fc` | deprecated alias for hpblock |
...
<!-- generator: scripts/generate-keysyms.mjs | header: /usr/include/xkbcommon/xkbcommon-keysyms.h | regenerate with `npm run generate:reference` -->
