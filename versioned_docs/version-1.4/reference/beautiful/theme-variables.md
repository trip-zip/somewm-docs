...
This is a reference of commonly used theme variables in the `beautiful` module. For a tutorial on creating themes, see [Theme Tutorial](/docs/tutorials/theme).
...
See [Input Devices: Cursor Theming](/docs/guides/input-devices#cursor-theming) for details.
:::
...
Compositor-level shadows for windows and wiboxes. See [Shadows Reference](/docs/reference/shadows) for full documentation.
...
- [Theme Tutorial](/docs/tutorials/theme) - Learn how to create themes
