...
SomeWM uses the SNI (StatusNotifierItem) protocol for the system tray instead of X11's XEmbed. See [Wayland vs X11](/docs/concepts/wayland-vs-x11) for details.
