...
SomeWM's `awful` implementation is fully compatible with AwesomeWM. See [Wayland vs X11](/docs/concepts/wayland-vs-x11) for platform-specific differences that may affect some operations.
