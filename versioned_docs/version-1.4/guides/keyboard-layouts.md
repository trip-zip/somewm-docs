...
- [Input Device Configuration](/docs/guides/input-devices) - Pointer and other keyboard settings
- [awful.input Reference](/docs/reference/awful/input) - All input properties
- [Wayland vs X11](/docs/concepts/wayland-vs-x11) - Why some features work differently
