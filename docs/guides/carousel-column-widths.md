...
- **[Stacking Guide](/guides/carousel-stacking)** - Combine windows vertically within a column
- **[Scrollable Tiling](/concepts/scrollable-tiling)** - How the strip and viewport model works
