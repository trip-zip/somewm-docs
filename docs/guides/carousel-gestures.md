...
- **[Centering Modes Guide](/guides/carousel-centering)** - Control how the viewport follows focus
- **[Scrollable Tiling](/concepts/scrollable-tiling)** - How the animation system works
