...
See the [centering modes guide](/guides/carousel-centering) for a full comparison.

## What's Next?

- **[Column Widths Guide](/guides/carousel-column-widths)** - Customize presets, set exact widths, maximize
- **[Stacking Guide](/guides/carousel-stacking)** - Consume, push, expel, and reorder columns
- **[Gesture Scrolling Guide](/guides/carousel-gestures)** - Gesture details and vertical variant setup
- **[Centering Modes Guide](/guides/carousel-centering)** - All four modes, peek width, programmatic scrolling
- **[Scrollable Tiling](/concepts/scrollable-tiling)** - The mental model behind the carousel
